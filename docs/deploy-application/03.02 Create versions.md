...
2. Click the **configuration** based on your IBMid.
...
6. Search and replace all instances of **#######abc-ns** with your specific **configuration** name.

The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **CONTROL+f** or **COMMAND+f** (this will vary depending on your computers operating system). Expand the dialog by clicking the ![](_attachments/expandIcon.png) icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific ```#######abc-ns``` value based on your IBMid and the name of your **Satellite configuration** (see animation below). The dialog should update with a **"1 of 6"** message.  Click the **replace all** ![](_attachments/replaceAllicon.png) icon to make the changes.

![](_attachments/0122-kafkaVersionYAML-modify.png)

7. Click **Add**.

![](_attachments/0122-kafkaVersionYAML-add.png)
...
9. Search and replace all instances of **#######abc-ns** with your specific **configuration** name.

The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **CONTROL+f** or **COMMAND+f** (this will vary depending on your computers operating system). Expand the dialog by clicking the ![](_attachments/expandIcon.png) icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific **#######abc-ns** value based on your IBMid and the name of your **Satellite configuration**. The dialog should update with a **"1 of 11"** message.  Click the **replace all** ![](_attachments/replaceAllicon.png) icon to make the changes.
...
12. Search and replace all instances of **#######abc-ns** with your specific **configuration** name.

The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **CONTROL+f** or **COMMAND+f** (this will vary depending on your computers operating system). Expand the dialog by clicking the ![](_attachments/expandIcon.png) icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific **#######abc-ns** value based on your IBMid and the name of your **Satellite configuration**. The dialog should update with a **"1 of 2"** message.  Click the **replace all** ![](_attachments/replaceAllicon.png) icon to make the changes.
...
15. Search and replace all instances of **#######abc-ns** with your specific **configuration** name.
...
metadata:
  ...
  namespace: #######abc-ns
spec:
  host: example-food-#######abc-ns.{{ aws.ingress }}
  port:
    targetPort: 8090
  to:
    kind: Service
...
18. Search and replace all instances of **#######abc-ns** with your specific **configuration** name.

The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **CONTROL+f** or **COMMAND+f** (this will vary depending on your computers operating system). Expand the dialog by clicking the ![](_attachments/expandIcon.png) icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific **#######abc-ns** value based on your IBMid and the name of your **Satellite configuration**. The dialog should update with a **"1 of 16"** message.  Click the **replace all** ![](_attachments/replaceAllicon.png) icon to make the changes.
...
metadata:
  ...
  namespace: #######abc-ns
spec:
  host: example-food-#######abc-ns.{{ ibm.ingress }}
  port:
    targetPort: 8090
  to:
    kind: Service
...
21. Search and replace all instances of **#######abc-ns** with your specific **configuration** name.
