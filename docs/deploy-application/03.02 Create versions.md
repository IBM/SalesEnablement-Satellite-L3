...
The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **CONTROL+f** or **COMMAND+f** (this will vary depending on your computers operating system). Expand the dialog by clicking the ![](_attachments/expandIcon.png) icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific **#######abc-ns** value based on your IBMid and the name of your **Satellite configuration**. The dialog should update with a **"1 of 6"** message.  Click the **replace all** ![](_attachments/replaceAllicon.png) icon to make the changes.
