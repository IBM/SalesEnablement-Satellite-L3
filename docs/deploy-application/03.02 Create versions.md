...
The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **<ctrl> f** or **<cmd> f** (this will vary depending on your computers operating system). Expand the dialog by clicking the **>** icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific **#######abc-ns** value based on your IBMid and the name of your **Satellite configuration**. The dialog should update with a **"1 of 6"** message.  Click the **replace all** icon to make the changes.
...
The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **<ctrl> f** or **<cmd> f** (this will vary depending on your computers operating system). Expand the dialog by clicking the **>** icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific **#######abc-ns** value based on your IBMid and the name of your **Satellite configuration**. The dialog should update with a **"1 of 11"** message.  Click the **replace all** icon to make the changes.
...
The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **<ctrl> f** or **<cmd> f** (this will vary depending on your computers operating system). Expand the dialog by clicking the **>** icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific **#######abc-ns** value based on your IBMid and the name of your **Satellite configuration**. The dialog should update with a **"1 of 2"** message.  Click the **replace all** icon to make the changes.
...
metadata:
  ...
  namespace: #######abc-ns
spec:
  host: example-food-#######abc-ns.aws-os-cluster-222b3514854c2221251113b2b051506c-0000.upi.containers.appdomain.cloud
  port:
    targetPort: 8090
  to:
    kind: Service
...
The YAML editor in the IBM Cloud portal has a **search and replace** function. Type **<ctrl> f** or **<cmd> f** (this will vary depending on your computers operating system). Expand the dialog by clicking the **>** icon next to the entry field.  In the first entry field, enter **#######abc-ns**.  In the second entry field, enter your specific **#######abc-ns** value based on your IBMid and the name of your **Satellite configuration**. The dialog should update with a **"1 of 16"** message.  Click the **replace all** icon to make the changes.
...
metadata:
  ...
  namespace: #######abc-ns
spec:
  host: example-food-#######abc-ns.ibmcloud-wdc-os-222b3514854c2221251113b2b051506c-0000.us-east.containers.appdomain.cloud
  port:
    targetPort: 8090
  to:
    kind: Service
