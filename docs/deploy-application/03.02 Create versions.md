...
9. Repeat the process and create a **version** called **food-delivery-frontend-v1**.
...
10. Repeat the process and create a **version** called **food-delivery-frontend-v2**.
...
11. Repeat the process and create a **version** called **development-route**.
...
metadata:
  ...
  namespace: #######abc-ns
spec:
  host: example-food-#######abc-ns.##SATELLITE.ingress##
  port:
    targetPort: 8090
  to:
    kind: Service
...
12. Repeat the process and create a **version** called **production-route**.
...
metadata:
  ...
  namespace: #######abc-ns
spec:
  host: example-food-#######abc-ns.##OPENSHIFT-CLUSTER.ingress##
  port:
    targetPort: 8090
  to:
    kind: Service
...
13. Verify the six (6) versions have been created. You should now see a total of 7 versions.
