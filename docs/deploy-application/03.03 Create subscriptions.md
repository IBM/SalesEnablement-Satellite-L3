...
!!! Note
    In some circumstances, you may see more than 2 entries in the details section. As long as you have a successful deployment to both {{ aws.cluster_name }} and {{ ibm.cluster_name }}, you can continue.  If one or more of the deployments fail, you need to verify the versions created in the previous step are correct. Make sure you successful replace all instances of **#######abc-ns** with your assigned namespace.

8. Click your **configuration** link to return to the configuration page.

![](_attachments/KafkaSubscriptionDeployedDetails-return.png)
