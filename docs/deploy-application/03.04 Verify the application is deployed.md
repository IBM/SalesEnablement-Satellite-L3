...
!!! warning
    You may experience a delay in the application reporting orders being fulfilled.  This usually occurs when the demonstration environment is experiencing heavy usage or starting for the first time. You can increase the speed of couriers and speed of kitches by adjusting the sliders. R

10. Repeat steps 2 thru 9 for the production environment cluster: **{{ ibm.cluster_name }}**.
