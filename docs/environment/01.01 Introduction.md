...
In this part of the demonstration script, you will exlore the provisioning of an IBM Cloud Satellite Location to a public clouid. In this case, AWS is the target public cloud. This initial deployment architecture is illustrated below.
