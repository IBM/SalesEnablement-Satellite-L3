...
2. Change from your IBM Cloud account to the demonstration IBM Cloud account: **2435442 - ITZ - Satellite***.

![](_attachments/ChangeAccounts.png)
...
**Note:** You may need to refresh the browser page or repeat step 1 after switching accounts to **2435442 - ITZ - Satellite***.
...
8. Click **aws-us-east-2**. 

![](_attachments/SatelliteLocations2.png)

!!! important
    The actual Satellite Location details may differ from the screen capture above. You will want to adjust your dialog to what you see.
...
!!! important
    The hosts details page may differ from the screen capture above. You will want to adjust your dialog to what you see.
